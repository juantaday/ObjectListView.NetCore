...
namespace BrightIdeasSoftware
{
    ...
    public partial class ObjectListView : ListView, ISupportInitialize
    {
        ...
        /// <summary>
        /// AllColumns - CONFIGURACIÓN CRÍTICA para serialización
        /// </summary>
        [Browsable(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        [Editor(typeof(OLVColumnCollectionEditor), typeof(UITypeEditor))]
        [Category("ObjectListView")]
        [Description("The columns that this ObjectListView will show")]
        [MergableProperty(false)] // Importante para evitar problemas de merge
        public List<OLVColumn> AllColumns
        {
            ...
            set
            {
                if (allColumns != value)
                {
                    allColumns = value ?? new List<OLVColumn>();

                    // Asignar Site a cada columna para serialización completa
                    if (Site != null)
                    {
        ...
        private CustomColumnCollection? customColumns;



        /// <summary>
        /// Evento cuando cambian las columnas
        /// </summary>
        public event EventHandler AllColumnsChanged;

        protected virtual void OnAllColumnsChanged()
        {
            AllColumnsChanged?.Invoke(this, EventArgs.Empty);
        }

        // Override SetSite para asignar Site a las columnas
        public override ISite Site
        {
            ...
            set
            {
                ...
                // Asignar Site a todas las columnas existentes
                if (value != null && allColumns != null)
                {
                    foreach (var column in allColumns)
                    {
                        if (column.Site == null)
        ...
        /// <summary>
        /// Colección de columnas del ObjectListView
        /// </summary>
        [Browsable(true)]
        [Category("Columns")]
        [Description("The columns displayed by this ObjectListView")]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Content)]
        [Editor(typeof(CustomColumnCollection), typeof(UITypeEditor))]
        ...
        public  void BeginInit()
        {
            ...
            {
                customColumns = new CustomColumnCollection(this);
            }
            // Asegurarse de que AllColumns no sea nulo
            if (allColumns == null)
            {
        ...
        /// <summary>
        /// Método llamado después de que el diseñador deserializa las propiedades
        /// </summary>
        public void EndInit()
        {
        ...
        /// <summary>
        /// Sincroniza las columnas visibles desde AllColumns
        /// </summary>
        internal void SyncColumnsFromAllColumns()
        {
            if (customColumns != null && allColumns != null)
            {
                customColumns.InternalClear();
                foreach (var column in allColumns)
                {
                    customColumns.InternalAdd(column);
                }
                UpdateBaseColumns();
            }
        }
        ...
        /// <summary>
        /// Actualizar las columnas base del ListView
        /// </summary>
        private void UpdateBaseColumns()
        {
            if (InvokeRequired)
            {
                Invoke(new Action(UpdateBaseColumnsInternal));
            }
            else
            {
                UpdateBaseColumnsInternal();
            }
        }

        private void UpdateBaseColumnsInternal()
        {
            try
            {
                base.Columns.Clear();
                if (customColumns != null)
                {
                    foreach (OLVColumn column in customColumns)
                    {
                        if (column.IsVisible)
            ...
            {
                System.Diagnostics.Debug.WriteLine("Error actualizando columnas: " + ex.Message);
            }
        }
        ...
        /// <summary>
        /// Add a column to AllColumns and update the display
        /// </summary>
        /// <param name="column"></param>


        public void AddColumn(OLVColumn column)
        {
        ...
        /// <summary>
        /// Remove a column from AllColumns and update the display
        /// </summary>
        /// <param name="column"></param>
        public void RemoveColumn(OLVColumn column)
        {
            if (column == null) return;
        ...
        /// <summary>
        /// Gets or sets an array of OLVColumns that will be used to initialize this control
        /// </summary>
        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public OLVColumn[] OLVColumns
        {
            get
            {
...
// ReSharper disable FieldCanBeMadeReadOnly.Global
        ...
        public virtual void AddObject(object modelObject)
        {
            if (this.InvokeRequired)
                this.Invoke((Action)delegate () { this.AddObject(modelObject); });
            else
        ...
        public virtual void AddObjects(ICollection modelObjects)
        {
            if (this.InvokeRequired)
            {
                this.Invoke((Action)delegate () { this.AddObjects(modelObjects); });
                return;
            }
...
#pragma warning restore 168
        ...
        {
            if (this.InvokeRequired)
                this.Invoke(new Action(this.BuildList));
            else
                this.BuildList(true);
        }
        ...
        {
            if (this.InvokeRequired)
                this.Invoke(new Action(this.ClearObjects));
            else
        ...
        {
            if (this.InvokeRequired)
                this.Invoke((Action)delegate () { this.RemoveObject(modelObject); });
            else
        ...
        public virtual void RemoveObjects(ICollection modelObjects)
        {
            if (this.InvokeRequired)
            {
                this.Invoke((Action)delegate () { this.RemoveObjects(modelObjects); });
                return;
            }
            if (modelObjects == null)
                return;
        ...
        public virtual void SetObjects(IEnumerable collection, bool preserveState)
        {
            if (this.InvokeRequired)
            {
                this.Invoke((Action)delegate { this.SetObjects(collection, preserveState); });
                return;
            }
        ...
        {
            if (this.InvokeRequired)
                this.Invoke((Action)delegate () { this.UpdateObject(modelObject); });
            else
        ...
        public virtual void UpdateObjects(ICollection modelObjects)
        {
            if (this.InvokeRequired)
            {
                this.Invoke((Action)delegate () { this.UpdateObjects(modelObjects); });
                return;
            }
        ...
        public virtual bool RestoreState(byte[] state)
        {
            ...
            {
                ObjectListViewState olvState = null;
                try
                {
                    ms.Position = 0; // Asegúrate de que la posición del stream esté al inicio
                    var dfddf = JsonSerializer.Deserialize<ObjectListViewState>(ms);
                }
                catch (JsonException)
                {
                    return false;
        ...
        private void ColumnSelectMenuItemClicked(object sender, ToolStripItemClickedEventArgs e)
        {
            ...
            this.BeginInvoke(new Action(this.RebuildColumns));
        }
        ...
        protected override void OnColumnReordered(ColumnReorderedEventArgs e)
        {
            ...
            this.BeginInvoke(new Action(this.RememberDisplayIndicies));
        }
        ...
        public virtual void RefreshObjects(IList modelObjects)
        {
            if (this.InvokeRequired)
            {
                this.Invoke((Action)delegate { this.RefreshObjects(modelObjects); });
                return;
            }
            foreach (object modelObject in modelObjects)
            {
        ...
        public virtual void Sort(OLVColumn columnToSort)
        {
            if (this.InvokeRequired)
            {
                this.Invoke((Action)delegate { this.Sort(columnToSort); });
            }
            else
            {
        ...
        public virtual void Sort(OLVColumn columnToSort, SortOrder order)
        {
            if (this.InvokeRequired)
            {
                this.Invoke((Action)delegate { this.Sort(columnToSort, order); });
            }
            else
            {
...
#pragma warning restore 168
        ...
        void ISupportInitialize.EndInit()
        {
            ...
            // Sincronizar columnas después de la inicialización
            if (allColumns.Count > 0)
            {
                RebuildColumns();
            }
        ...
        protected override void OnMouseUp(MouseEventArgs e)
        {
                ...
                !String.IsNullOrEmpty(args.SubItem.Url))
            {
                ...
                this.BeginInvoke((Action)delegate { this.ProcessHyperlinkClicked(args); });
            }
        ...
        protected override void OnHandleCreated(EventArgs e)
        {
            ...
            this.Invoke((Action)this.OnControlCreated);
        }

        /// <summary>
        /// Sobrescribir para manejar la serialización del diseñador
        /// </summary>
        protected override void OnCreateControl()
        {
            base.OnCreateControl();

            // Sincronizar columnas al crear el control
            if (allColumns.Count > 0 && (customColumns == null || customColumns.Count == 0))
            {
                SyncColumnsFromAllColumns();
            }
        }
        ...
        // Método auxiliar en la clase ObjectListView principal


        /// <summary>
        /// Obtiene acceso a la colección base de columnas
        /// </summary>
        internal ListView.ColumnHeaderCollection GetBaseColumns()
        {
            return base.Columns;
        }
        #endregion
    ...
    /// <summary>
    /// Colección de columnas personalizadas
    /// </summary>
    public class CustomColumnCollection : CollectionBase
    {
        private readonly ObjectListView owner;

        public CustomColumnCollection(ObjectListView owner)
        {
            this.owner = owner;
        }

        public OLVColumn this[int index]
        {
            get { return (OLVColumn)List[index]; }
            set
            {
                List[index] = value;
                owner?.RebuildColumns();
            }
        }

        public int Add(OLVColumn column)
        {
            int result = List.Add(column);
        ...
        public void Remove(OLVColumn column)
        {
            List.Remove(column);
            if (!owner.isInitializing)
            {
        ...
        public bool Contains(OLVColumn column)
        {
            return List.Contains(column);
        }

        public int IndexOf(OLVColumn column)
        {
            return List.IndexOf(column);
        }

        // Aplicar la misma lógica a Insert, Remove, etc.
        public void Insert(int index, OLVColumn column)
        {
        ...
        public void AddRange(OLVColumn[] columns)
        {
        ...
        /// <summary>
        /// Métodos internos para evitar bucles infinitos durante la sincronización
        /// </summary>
        internal void InternalAdd(OLVColumn column)
        {
            List.Add(column);
        }
