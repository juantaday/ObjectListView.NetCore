...
namespace BrightIdeasSoftware {
    ...
    public partial class TreeListView {
        ...
        public class TreeRenderer : HighlightTextRenderer {
            ...
            [Category("Behavior")]
            [Description("Should the renderer draw glyphs at the expansion points?")]
            [DefaultValue(true)]  
            ...
            /// </remarks>
            [Category("Appearance")]
            [Description("Should the renderer draw triangles as the expansion glyphs?")]
            [DefaultValue(false)]  // Evita que se serialice innecesariamente
