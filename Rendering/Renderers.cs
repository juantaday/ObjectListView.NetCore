...
namespace BrightIdeasSoftware {
    ...
    public class ImageRenderer : BaseRenderer {
        ...
        public void OnTimer(Object state) {
            ...
            if (this.ListView.InvokeRequired)
                this.ListView.Invoke((Action) delegate { this.OnTimer(state); });
            else
    ...
    public class ClickableButtonColumn : OLVColumn
    {
        public event EventHandler<EventArgs> ButtonClick;

        public ClickableButtonColumn()
        {
            this.Renderer = new ColumnButtonRenderer();
            ((ColumnButtonRenderer)this.Renderer).ButtonClick += Renderer_ButtonClick;
        }

        private void Renderer_ButtonClick(object sender, EventArgs e)
        {
            OnButtonClick();
        }
