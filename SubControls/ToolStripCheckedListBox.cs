...
namespace BrightIdeasSoftware {
    ...
    public class ToolStripCheckedListBox : ToolStripControlHost {
        ...
        /// </summary>
        [Category("Behavior")]
        [Description("Gets or sets whether an item should be checked when it is clicked.")]
        [DefaultValue(false)]  // Ajusta el valor predeterminado según el comportamiento esperado
